...
class BankAccount:
    ...
    def deposit(self, amount):
        ...
        self.change_transaction(self.transaction_id, self.balance - amount, self.balance)
        return self.balance
    ...
    def withdraw(self, amount):
        ...
        if amount > self.balance:
            self.change_transaction(self.transaction_id, self.balance, self.balance)
            return 'Insufficient funds'
        self.balance = self.balance - amount
        self.change_transaction(self.transaction_id, self.balance + amount, self.balance)
        return self.balance
    
    def change_transaction(self, id, before, after):
        transaction = Transaction(self.transaction_id, before, after)

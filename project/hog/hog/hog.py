...
def boar_brawl(player_score, opponent_score):
    ...
    num = abs(player_num - opponent_num)
    if num == 0:
        num = 1
    else:
        num = num * 3
...
def sus_update(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    score = sus_points(score + player_score)
    return score
    # END PROBLEM 4
...
def always_roll(n):
    ...
    # BEGIN PROBLEM 6-  -
    "*** YOUR CODE HERE ***"
    def roll_num(score, opponent_score):
        return n
    return roll_num
    # END PROBLEM 6
